...
// default settins
var image_path = "tigra_calendar/img/";
/*******************************
Added By Upkar For Admin Section
********************************/
if(window.location.href.toLowerCase().match('admin')!=null)
{
    image_path = "../../tigra_calendar/img/";
}
if(window.location.href.toLowerCase().match('chapterportal')!=null)
{
    image_path = "../tigra_calendar/img/";
}
/*******************************/
var A_TCALDEF = {
	...
	'imgpath' : image_path // directory with calendar images
}
